...
class VimeoTool_Configuration extends Core_Configuration_Model	{
	...
	protected function build_form() {
		...
		$this->add_field('consumer_key', 'Consumer Key', 'full', db_varchar)->tab('Authentication')->comment('Client ID from Vimeo', 'above');
		$this->add_field('consumer_secret', 'Consumer Secret', 'full', db_varchar)->tab('Authentication')->comment('Client Secret from Vimeo', 'above');
